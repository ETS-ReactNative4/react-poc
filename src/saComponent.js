...
export default class saComponent extends React.Component {
  ...
  constructor(props) {
    ...
    handleChange(event){
      if(event.target.value!=""){
        ...
        this.setState({gradeDetails: {"studentname":"","assessment":[]}});
        //this.setState({assessmentArray:[{"inputVal":"","inputUnit":"","targetUnit":"","response":""}]});
      }else{
  ...
  assessStudent(e){
    ...
    ReactDOM.findDOMNode(this.refs.studentSelect).value = "";
    //$("#studentSelect").val("");
  ...
  render() {
    return (
        ...
        <FormGroup row>
          ...
          <Col sm={3}>
          <Input type="select" name="studentSelect" id="studentSelect" ref="studentSelect" onChange={(e) => this.handleChange(e) }>
